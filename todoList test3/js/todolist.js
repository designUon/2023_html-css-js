...
function checkedCount(){
    ...
    const result = document.querySelector("#result");
    const liList = document.querySelectorAll("#todolist input[type='checkbox']")

    const liChecked = document.querySelectorAll("#todolist input[type='checkbox']:checked")

    result.innerHTML = `전체 할 일 : ${liList.length} / 완료한 일 : ${liChecked.length}`;
}
